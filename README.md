...
* **Production** - [https://arrow-challenge-production.herokuapp.com](https://arrow-challenge-production.herokuapp.com)
* **Staging** - [https://arrow-challenge-staging.herokuapp.com](https://arrow-challenge-staging.herokuapp.com)
...
* [Github repo](https://github.com/IcaliaLabs/arrow-challenge)
...
```bash
$ git clone git@github.com:IcaliaLabs/arrow_challenge.git
...
That command will lift every service arrow-challenge needs, such as the `rails server`, `postgres`, and `redis`.
...
In order to stop arrow-challenge as a whole you can run:
...
You probably won't be working with a blank database, so once you are able to run arrow-challenge you can restore the database, to do it, first stop all services:
...
```
% docker exec -ti arrow_challenge_db_1 bash
```

This will open up a bash session in to the database container.

Up to this point we just need to download a database dump and copy under `arrow-challenge/backups/`, this directory is mounted on the container, so you will be able to restore it with:

```
root@a3f695b39869:/# bin/restoredb arrow_challenge_dev db/backups/<databaseDump>
```
